...
1. workflow: plan -> use rubber duck skill to review plan -> address plan review comments -> implement(TDD style) -> use simplify skill to clean up code -> use rubber duck skill to review implementation -> address code review comments -> build vsix -> install vsix
1. sub-agents:
